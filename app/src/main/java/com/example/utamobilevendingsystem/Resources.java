...
public class Resources {
    ...
    public static final String CREATE_TABLE_USER_CREDENTIALS = "CREATE TABLE " + TABLE_USER_CREDS
    ...
    public static final String CREATE_TABLE_STATUS = "CREATE TABLE " + TABLE_USER_CREDS
    ...
    public static final String CREATE_TABLE_VEHICLE = "CREATE TABLE " + TABLE_VEHICLE
    ...
    public static final String CREATE_TABLE_VEHICLE_INVENTORY = "CREATE TABLE " + TABLE_VEHICLE_INVENTORY
    ...
    public static final String CREATE_TABLE_OPERATOR_VEHICLE = "CREATE TABLE " + TABLE_OPERATOR_VEHICLE
    ...
    public static final String CREATE_TABLE_PAYMENTS = "CREATE TABLE " + TABLE_PAYMENTS
    ...
    public static final String CREATE_TABLE_USER_ORDER = "CREATE TABLE " + TABLE_USER_ORDER
    ...
    public static final String CREATE_TABLE_USER_CART = "CREATE TABLE " + TABLE_USER_CART
